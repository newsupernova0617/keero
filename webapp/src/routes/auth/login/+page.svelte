...
<div class="flex min-h-screen items-center justify-center">
	<Card.Root class="w-full max-w-md">
		<Card.Header class="text-center">
			<Card.Title class="text-3xl">ë¡œê·¸??/Card.Title>
			<Card.Description>?Œì…œ ê³„ì •?¼ë¡œ ê°„í¸?˜ê²Œ ë¡œê·¸?¸í•˜?¸ìš”</Card.Description>
		</Card.Header>
		...
		<Card.Content class="space-y-4">
			...
			<p class="text-center text-xs text-muted-foreground">
				ë¡œê·¸?¸í•˜ë©?<a href="/terms" class="underline">?´ìš©?½ê?</a> ë°?
				<a href="/privacy" class="underline">ê°œì¸?•ë³´ì²˜ë¦¬ë°©ì¹¨</a>???™ì˜?˜ëŠ” ê²ƒìœ¼ë¡?ê°„ì£¼?©ë‹ˆ??
			</p>
		</Card.Content>
	</Card.Root>
</div>
